...
class GUI:
    ...
    def __init__(self, root):
        ...
        self.scrl_out_ru.grid         (column=5, row=1, sticky=(W, E))
        self.scrl_out_en.grid         (column=5, row=2, sticky=(W, E))
        ...
        ttk.Label(mainframe, text="Out Russian Field:").grid(column=4, row=1, sticky=W)
        ttk.Label(mainframe, text="Out English Field:").grid(column=4, row=2, sticky=W)
        ...
        ttk.Button(mainframe, text="Generate", command=self.button_generate).grid(column=2, row=0)
        ttk.Button(mainframe, text="Clear", command=self.button_clear).grid(column=3, row=0)
        ...
        #ttk.Button(mainframe, text="Update", command=self.test_cmd).grid(column=2, row=0)
        #ttk.Entry(mainframe, width=WIDTH, textvariable=self.).grid(column=, row=, sticky=(W, E))

        #entry_query = ttk.Entry(mainframe, width=7, textvariable=self.feet)

...
class GUI:
    ...
    def __init__(self, root):
        ...
        self.scrl_gen_examples.grid   (column=1, row=3, sticky=(W, E))
        self.scrl_gen_related.grid    (column=1, row=4, sticky=(W, E))
        self.scrl_gen_synos.grid      (column=1, row=5, sticky=(W, E))
        #self.frame_imgs.grid          (column=1, row=7, sticky=(W, E))
        self.entry_quick.grid         (column=1, row=6, sticky=(W, E))
        ...
        ttk.Label(mainframe, text="Quick Query:").grid(column=0, row=6, sticky=W)
        ...
        ttk.Label(mainframe, text="Generated Examples:").grid(column=0, row=3, sticky=W)
        ttk.Label(mainframe, text="Generated Related:").grid(column=0, row=4, sticky=W)
        ttk.Label(mainframe, text="Generated Synonyms:").grid(column=0, row=5, sticky=W)
        ...
        ttk.Button(mainframe, text="Search", command=self.button_search).grid(column=2, row=6)
        ttk.Button(mainframe, text="Submit", command=self.button_submit).grid(column=3, row=7, pady=20)


    def list_to_str(self, list_in):
        out = ""
        for elem in list_in:
            out += str(elem)
            out += "\n"
    ...
    def button_search(self):
        ...
        query = self.stringvar_quick.get()
        print(query)

        # Obtain fields
        card_fields = russian_tool.quick_search(query)
